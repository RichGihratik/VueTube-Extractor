 ...
 *
 * @property {string} baseessage - Error message
 ...
 */
export class VueTubeExtractorError extends Error {
  name = "VueTubeExtractorError";
  ...
  set baseMessage(message: string) {
    this._baseMessage = message;
    this.message = ErrorMessages.reportBug(message);
  }
  ...
  constructor(
    private _baseMessage: string, 
    details?: unknown
  ) {
    super(ErrorMessages.reportBug(_baseMessage));
